...
class FakePopRepository(private val cannedPeriod: PopPeriod) : PopRepository {
    override suspend fun period(coords: Coordinates, units: Units): PopPeriod = cannedPeriod
}